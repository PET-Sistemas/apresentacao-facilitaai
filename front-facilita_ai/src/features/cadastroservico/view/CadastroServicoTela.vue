      ...
      <div class="form-container">
        ...
        <form class="cadastroservico">
          <div class="name-field">
            <label for="name">Título do serviço</label>
            <input type="text" id="name" placeholder="" v-model="viewModel.name" />
          </div>
          
          <div class="description-field">
            <label for="description">Descrição do serviço</label>
            <input type="text" id="description" placeholder="" v-model="viewModel.description" />
          </div>

          <div class="price-field">
            <label for="price">Valor do serviço</label>
            <input type="number" id="price" placeholder="" v-model="viewModel.price" />
          </div>
        </form>
        ...
        <div class="button-sign">
            <router-link to="/">
              <button id="button-sign2" @click="viewModel.submitForm">Publicar serviço</button>
            </router-link>
        </div>
